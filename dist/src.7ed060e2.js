...
exports.IMG_NOT_AVIALABLE = exports.IMG_STANDART_XLARGE = exports.API_CHARACTERS = exports.API_COMICS = exports.API_URL = exports.API_KEY = void 0;
var API_KEY = 'a5837db97d72016c81a7a776f4240db9',
    API_URL = 'https://gateway.marvel.com/v1/public/',
    API_COMICS = 'comics',
    API_CHARACTERS = 'characters',
    IMG_STANDART_XLARGE = 'standard_xlarge',
    IMG_NOT_AVIALABLE = 'image_not_available';
exports.IMG_NOT_AVIALABLE = IMG_NOT_AVIALABLE;
exports.IMG_STANDART_XLARGE = IMG_STANDART_XLARGE;
exports.API_CHARACTERS = API_CHARACTERS;
exports.API_COMICS = API_COMICS;
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Error":"../src/components/Error/Error.js"}],"../src/components/Notification/Notification.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
exports.default = _default;
},{"../../constants/root":"../src/constants/root.js","./Notification.css":"../src/components/Notification/Notification.css"}],"../src/components/Notification/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Notification":"../src/components/Notification/Notification.js"}],"../src/components/Characters/Characters.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
  ...
  _createClass(Characters, [{
    ...
    value: function renderContent(data) {
      ...
      data.forEach(function (_ref) {
        ...
        htmlContent += "\n                <li class=\"characters__item\">\n                    <img src=\"".concat(imgSrc, "\" class=\"characters__item-img img-cover\" />\n                    <span class=\"characters__item-name\">").concat(name, "</span>\n                </li>\n            ");
      });
      var wrapperHTML = "\n            <div class=\"characters\">\n                <ul class=\"characters__container\">\n                    ".concat(htmlContent, "\n                </ul>\n                <button class=\"characters__close close-btn btn\" onclick=\"modal.innerHTML = '' \">\xD7</button>\n            </div>\n        ");
      _root.ROOT_MODAL.innerHTML = wrapperHTML;
    }
  }, {
    key: "render",
    value: function () {
...
exports.default = _default;
},{"../../utils/getDataApi":"../src/utils/getDataApi.js","../../constants/api":"../src/constants/api.js","../../constants/root":"../src/constants/root.js","../Notification":"../src/components/Notification/index.js","./Characters.css":"../src/components/Characters/Characters.css"}],"../src/components/Characters/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Characters":"../src/components/Characters/Characters.js"}],"../src/Comics/Comics.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/Comics/Comics.js":[function(require,module,exports) {
"use strict";
...
var Comics = /*#__PURE__*/function () {
  ...
  _createClass(Comics, [{
    key: "comicsRender",
    value: function comicsRender(data) {
      var htmlContent = '';
      data.forEach(function (_ref) {
        var id = _ref.id,
            title = _ref.title,
        ...
        if (path.lastIndexOf(_api.IMG_NOT_AVIALABLE) === -1 && description !== null) {
          var uri = _api.API_URL + _api.API_COMICS + '/' + id + '/' + _api.API_CHARACTERS;
          var imgSrc = path + '/' + _api.IMG_STANDART_XLARGE + '.' + extension;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _getDataApi.getDataApi.getData(_api.API_URL + _api.API_COMICS);

              case 2:
                data = _context.sent;
                data ? this.comicsRender(data) : _Error.default.render();
...
exports.default = _default;
},{"../utils/getDataApi":"../src/utils/getDataApi.js","../constants/api":"../src/constants/api.js","../constants/root":"../src/constants/root.js","../components/Error":"../src/components/Error/index.js","../components/Characters":"../src/components/Characters/index.js","./Comics.css":"../src/Comics/Comics.css"}],"../src/Comics/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Comics":"../src/Comics/Comics.js"}],"../src/components/App/App.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
exports.default = _default;
},{"../../Comics":"../src/Comics/index.js","./App.css":"../src/components/App/App.css"}],"../src/components/App/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./App":"../src/components/App/App.js"}],"../src/comics/Comics.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
exports.default = _default;
},{"../utils/getDataApi":"../src/utils/getDataApi.js","../constants/api":"../src/constants/api.js","../constants/root":"../src/constants/root.js","../components/Error":"../src/components/Error/index.js","../components/Characters":"../src/components/Characters/index.js","./Comics.css":"../src/comics/Comics.css"}],"../src/index.js":[function(require,module,exports) {
"use strict";
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./components/App":"../src/components/App/index.js","./comics/Comics":"../src/comics/Comics.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
